...
# To do:
# - modify the function template to allow for functions that vary for multiple input instances
# - Modify the subset sampling algorithm to correctly sample for both reference and target instances